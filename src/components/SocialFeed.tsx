    ...
    <section id="social-feed" className="mb-8 p-5 bg-gray-50 rounded-md">
      ...
      <div className="mb-4 flex space-x-2">
        ...
        <button 
          ...
          className={`px-4 py-2 rounded-md ${activeTab === 'facebook' ? 'bg-blue-600 text-white' : 'bg-gray-200'}`}
        >
          Facebook
        </button>
        <button 
          onClick={() => setActiveTab('instagram')}
          className={`px-4 py-2 rounded-md ${activeTab === 'instagram' ? 'bg-purple-600 text-white' : 'bg-gray-200'}`}
        >
          Instagram
        </button>
      </div>
