                ...
                <div key={image.id} className="card">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex -space-x-2 mb-4">
                      ...
                      <div className="w-8 h-8 rounded-full border-2 border-gray-700 bg-blue-500 flex items-center justify-center text-white text-xs">
                        +38
                      </div>
                    </div>
                ...
                <div key={i} className="relative group overflow-hidden rounded-md">
                  <div className="aspect-square bg-gray-200 relative">
                    ...
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <button className="bg-blue-500 text-white py-1 px-3 rounded-full text-sm hover:bg-blue-700 transition-colors">
                        View
                      </button>
                    </div>
                  </div>
